...
public:
	...
	virtual void VOnUpdate(std::chrono::nanoseconds delta) = 0;
...
{
public:
	HumanView(ChessGame& board);
	HumanView(ChessGame& board, int left, int right, int top, int bottom);
	HumanView(ChessGame& board, Color background, Color first, Color second);
	HumanView(ChessGame& board, Color background, Color first, Color second, int left, int right, int top, int bottom);

	virtual void VOnInitialize(const std::string& xml_view_settings) override final;
	virtual void VOnResize() override final;
	virtual void VOnInput() override final;
	virtual void VOnRender() override final;
	virtual void VOnUpdate(std::chrono::nanoseconds) override final;

	// Accessors
	inline void GetHovering(int& x, int& y) const noexcept { x = this->m_Hovering_x; y = this->m_Hovering_y; }
	inline void GetSelected(int& x, int& y) const noexcept { x = this->m_Selected_x; y = this->m_Selected_y; }
	inline void SetHovering(int x, int y) noexcept { this->m_Hovering_x = x; this->m_Hovering_y = y; }
	inline void SetSelected(int x, int y) noexcept { this->m_Selected_x = x; this->m_Selected_y = y; }

	inline int GetHoveringX() const noexcept { return this->m_Hovering_x; }
	inline int GetHoveringY() const noexcept { return this->m_Hovering_y; }
	inline int GetSelectedX() const noexcept { return this->m_Selected_x; }
	inline int GetSelectedY() const noexcept { return this->m_Selected_y; }
	inline void SetHoveringX(int x) noexcept { this->m_Hovering_x = x; }
	inline void SetHoveringY(int y) noexcept { this->m_Hovering_y = y; }
	inline void SetSelectedX(int x) noexcept { this->m_Selected_x = x; }
	inline void SetSelectedY(int y) noexcept { this->m_Selected_y = y; }
		
	inline void SetHighLight_HoveringSquare(bool highlight) noexcept { this->m_HighLight_Hovering = highlight; }
	inline void SetHighLight_Targets(bool highlight) noexcept { this->m_HighLight_Targets = highlight; }
	inline void SetHighLight_Checks(bool highlight) noexcept  { this->m_HighLight_Checks = highlight; }
	inline void SetHighLight_SelectedPiece(bool highlight) noexcept	{ this->m_HighLight_SelectedPiece = highlight; }
	inline void SetHighLight_PossibleMoves(bool highlight) noexcept	{ this->m_HighLight_PossibleMoves = highlight; }
	inline bool GetHighLight_HoveringSquare() const noexcept { return this->m_HighLight_Hovering; }
	inline bool GetHighLight_Targets() const noexcept { return this->m_HighLight_Targets; }
	inline bool GetHighLight_Checks() const noexcept  { return this->m_HighLight_Checks; }
	inline bool GetHighLight_SelectedPiece() const noexcept	{ return this->m_HighLight_SelectedPiece; }
