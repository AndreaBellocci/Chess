...
const EventType Event_PromotePawn::sk_EventType			(0xa3814acd);
const EventType Event_PawnPromotion::sk_EventType		(0xa3814ace);
const EventType Event_EndMatch::sk_EventType			(0xa3814acf);